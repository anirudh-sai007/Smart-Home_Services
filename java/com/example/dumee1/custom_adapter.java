...
public class custom_adapter extends ArrayAdapter<custom_item>

    {

    public custom_adapter(@NonNull Context context, ArrayList<custom_item> customList) {
        ...
        custom_item item = getItem(position);
