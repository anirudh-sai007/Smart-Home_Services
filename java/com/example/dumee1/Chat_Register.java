...
public class Chat_Register extends AppCompatActivity {
    // Widgets
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat__register);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(username_text) || TextUtils.isEmpty(email_text) || TextUtils.isEmpty(pass_text)){
                    Toast.makeText(Chat_Register.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                }else{
                        ...
                        if (task.isSuccessful()){
                            ...
                            myRef.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        Intent i = new Intent(Chat_Register.this, MainActivity.class);
                            ...
                            Toast.makeText(Chat_Register.this, "Invalid Email or Password", Toast.LENGTH_SHORT).show();
                        }
